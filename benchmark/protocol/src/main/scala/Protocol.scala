...
object protocol {
  ...
  val definition =
    Protocol.empty
      ...
      .specify1[MediumW, MediumW]("identityMedium", Field.strict[MediumW]("in"), Type.strict[MediumW])
      .specify1[BigW, BigW]("identityBig", Field.strict[BigW]("in"), Type.strict[BigW])
}
